...
Index(f"outpoints_idx_creating_outpoint", TransactionOutput.transaction_id, TransactionOutput.index)
...
Index(f"inputs_idx_creating_outpoint", TransactionInput.previous_outpoint_hash, TransactionInput.previous_outpoint_index)
